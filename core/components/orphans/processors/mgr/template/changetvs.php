...
if (empty($scriptProperties['template'])) return $modx->error->failure($modx->lexicon('orphans.template_err_ns'));
...
if (empty($scriptProperties['tvs'])) return $modx->error->failure($modx->lexicon('orphans.tvs_err_ns'));
